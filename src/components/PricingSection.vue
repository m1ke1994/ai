          ...
          <div class="relative z-10 flex h-full flex-col">
            <div>
              <div class="flex items-start justify-between gap-3">
                <div>
                  <h4
                    ...
                    :class="plan.darkCard ? 'text-white' : 'text-[#111218]'"
                  >
                    {{ plan.name }}
                  </h4>
              ...
              <div
                ...
                :class="plan.darkCard ? 'opacity-15' : 'opacity-100'"
              />
            ...
            <div class="mt-auto pt-5">
              <div
                ...
                "
              >
                <span class="font-semibold" :class="plan.darkCard ? 'text-white' : 'text-[#2E334A]'">Каналы:</span>
                {{ ' ' }}{{ plan.channels }}
              </div>
