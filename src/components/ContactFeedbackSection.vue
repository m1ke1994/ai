<template>
  <section id="contacts" class="relative scroll-mt-[92px] overflow-hidden rounded-none sm:rounded-[40px] bg-[#01020a] pt-8 pb-0 sm:pt-10 sm:pb-0 lg:scroll-mt-[104px] lg:pt-12 lg:pb-0">
    <img
      src="/bg-fon.png"
      alt=""
      aria-hidden="true"
